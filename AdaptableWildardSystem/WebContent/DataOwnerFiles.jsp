       ...
       <table border="0" cellpadding="10" cellspacing="1" style="width:100%; border:1px solid #ccc; margin-top:40px" >
                   ...
                   // boolean Authorised=false;
                       GlobalFunction GF = new GlobalFunction();
                        ...
                        ResultSet rs = st.executeQuery("select * from userfile where uploadedBy='"+Userid+"' or identity='"+Userid+"'");
                        while(rs.next()){
                      ...
                      String grpname = GF.getUserGroupName(grpid);
                        ...
                        System.out.print("f rts id is "+Fileid);
                        
                        
                        session.setAttribute("f_id", Fileid);
                    ...
                    <tr class="tablerow">
                        ...
                        <td><%= srno++ %><input type="hidden" name="aa" value="<%=Fileid%>"/></td>
                        ...
                        <td>
                        <a  href="DownloadServlet?fileName=<%= fileName %>&fileId=<%=Fileid %>" style="color:maroon; ">Download</a>
                        <a style="color:blue; display:none" onclick="SendVerificationRequest(<%= Fileid %>)">Verify File</a></td>
                        <td><a style="color:blue; display:none" onclick="SendVerificationRequest(<%= Fileid %>)">Verify File</a></td>
