...
<div class="wrapper col4">
  <div id="container">
    <div id="hpage" align="center">
      ...
      <form action="VerifySecretKey" method="post">
           <table border="0" cellpadding="10" cellspacing="1" style="width:50%; border:1px solid #ccc; margin-top:40px; margin-left: auto; margin-right: auto" >
                    ...
                    <tr class="tableheader">
                        <td colspan="3">File Secret Key</td>
                   ...
                   // boolean Authorised=false;
                    ...
                    <tr class="tablerow">
                     ...
                     <tr class="tablerow">
                       <td>Cloud Key</td><td>:</td><td><%= rs.getString("CloudSecretKey") %></td>
                    </tr>
                    <tr class="tablerow">
                       <td>Data Owner Key</td><td>:</td><td><%= rs.getString("UserSecretKey") %></td>
                    </tr>
                        ...
                        <tr class="tablerow">
                     	...
                     	<td>Enter User Secret key</td><td>:</td><td>
                     	<%    
                        ...
                        while(rsq.next()){
                        	//UserFileSecKey[] = rsq.getString("Status");
                        	secK.add(rsq.getString("Status"));
                        	//out.println(UserFileSecKey);                          
                        }
                        //String stc = String.join(", ", secK);
                       // out.println(stc.replaceAll(", ", ""));  
                  %>
<%--                      	<input type="text" name="FileSecretKey" value="<%= stc.replaceAll(", ", "") %>"></input> --%>
                    ...
                    <tr class="tableheader">
                    <td colspan="3"><input type="submit" value="Decrypt File" name="submit"></input></td>
                    </tr>
                    <%
