...
<div class="wrapper col4">
  <div id="container">
    <div id="hpage" align="center">
       ...
       <form action="ProxyHome.jsp" name="ulogin" method="post" onsubmit="return validation()"> 
	        <table cellpadding="5" cellspacing="5" border="0" width="350" >
				<tr>
					<td colspan="3" class="ttlbgcolor"><div style="margin:5px">Proxy Login !</div></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="3" align="right"><div style="margin-right:20px">&nbsp;&nbsp;&nbsp;&nbsp; <input type="submit" value="Login" name="submit" /></div></td>
				</tr>
			</table>
			</form>
