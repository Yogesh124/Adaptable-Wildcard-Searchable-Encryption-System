...
<script>
    ...
    function RegenerateFile(Fileid) {
        ...
        //alert(Fileid);
         ...
         $.ajax({
             ...
             success:function(data){
                 ...
                 alert("Regenerate File to Cloud Server");
...
<div class="wrapper col4">
  <div id="container">
    <div id="hpage" align="center">
        <h2>View All Files To Regenerate</h2>
           ...
           <table border="0" cellpadding="10" cellspacing="1" style="width:100%; border:1px solid #ccc; margin-top:40px" >
                   ...
                   // boolean Authorised=false;
                       GlobalFunction GF = new GlobalFunction();
                        ...
                        ResultSet rs = st.executeQuery("select * from userfile where VerificationStatus='Hacked'");
                        while(rs.next()){
                    ...
                    <tr class="tablerow">
                        ...
                        <td><%= uploadDate %></td>
                         <td><%
                         String vst = rs.getString("VerificationStatus");
                         if(vst.equalsIgnoreCase("1")){
                          ...
                          %></td>
                        <td>
                        <a  href="DownloadServlet?fileName=<%= fileName %>" style="color:maroon;  display:none">Download</a>
                        <a style="color:blue" onclick="RegenerateFile(<%= Fileid %>)">Regenerate File</a></td>
