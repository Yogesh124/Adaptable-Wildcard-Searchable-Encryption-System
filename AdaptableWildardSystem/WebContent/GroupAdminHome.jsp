...
<div class="wrapper col4">
  <div id="container">
    <div id="hpage" align="center">
      ...
      <h5 style="color: steelblue">Welcome Group Admin</h5>
      ...
      <table border="0" cellpadding="10" cellspacing="1" style="width:100%; border:1px solid #ccc; margin-top:40px" >
                   ...
                   // boolean Authorised=false;
                       ...
                       GlobalFunction GF = new GlobalFunction();
                        ...
                        ResultSet rs = st.executeQuery("select * from groupuser where id="+UserId);
                        while(rs.next()){
                       String GID = rs.getString("id"); 
                       String GroumMember = GF.getNumberOfUserInGroup(GID);
