      ...
      <h5 style="color: steelblue">Welcome <%=(String)session.getAttribute("fname")%></h5>
       ...
       GlobalFunction GF = new GlobalFunction();
                        ...
                        while(rs.next()){
                        	...
                        	String GroupName = GF.getUserGroupName(rs.getString("GroupID"));
                            %>
           <table cellspacing="1" cellpadding="10" style="width:50%; line-height: 30px; margin-left: auto; margin-right: auto;">
               ...
               <tr class="tableheader">
                   ...
                   <tr class="tablerow">
                        <td><span style="color: brown; font-weight: bold;">Group</span> </td><td>:</td><td><%= GroupName %></td>                        
                    </tr>   
                    <tr class="tablerow">
                    ...
                    <tr class="tablerow" >
                        <td colspan="3"><a href="DOupdate_account.jsp?userid=<%= rs.getString("id")%>">Edit Account</a></td>                        
                    </tr>
