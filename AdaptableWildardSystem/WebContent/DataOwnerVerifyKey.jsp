...
<div class="wrapper col4">
  <div id="container">
    <div id="hpage" align="center">
      <h2>DataOwner Permission</h2>
      
       <form action="VerifyDataownerKey" method="post">
           <table border="0" cellpadding="10" cellspacing="1" style="width:50%; border:1px solid #ccc; margin-top:40px; margin-left: auto; margin-right: auto" >
                    ...
                    <tr class="tableheader">
                        <td colspan="3">DataOwner Permission</td>
                     ...
                     <tr class="tablerow">
                       <td>Cloud Key</td><td>:</td><td><%= rs.getString("CloudSecretKey") %></td>
                        ...
                        <tr class="tablerow">
                     	...
                     	<td>Enter DataOwner key</td><td>:</td><td><input type="text" name="UserSecretKey"></input></td>
                     </tr>
                       <tr class="tablerow">
                    <td colspan="3">&nbsp;</td>
                    </tr>
