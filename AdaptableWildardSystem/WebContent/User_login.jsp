	       ...
	       <form action="UserLogin" name="ulogin" method="post"> 
	        <table cellpadding="5" cellspacing="5" border="0" width="100%">
				...
				<tr>
					...
					<td><strong>:</strong></td>
					<td>
					<input type="text" name="username" id="username" onchange="return validEmail1()" required="required"/>
				...
				<tr>
					...
					<a href="Userreg.jsp">New Register?</a></td>
				</tr>
			</table>
			</form>
       ...
       <form action="Registration" name="ureg" method="post" onsubmit="return validation()"> 
	        <table cellpadding="5" cellspacing="5" border="0" width="100%">
				...
				<tr>
					...
					<td><strong>:</strong></td>
					<td><input type="text" name="contactNo" id="contactNo" onblur="return Validate()" required="required"/></td>
				</tr>
				<tr>
					
					<td><strong>Email</strong></td>
					<td><strong>:</strong></td>
					<td><input type="text" name="email" id="email" onblur="return validEmail()" required="required"/></td>
				</tr>
