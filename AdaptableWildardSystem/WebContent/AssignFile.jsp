...
<div class="wrapper col2">
  <div id="topnav">
    <%@ include file="dataowner_menu.jsp"%>
  </div>
</div>
<!-- ####################################################################################################### -->
...
<div class="wrapper col4">
  <div id="container">
    <div id="hpage" align="center">
       ...
       <form action="AuthorisedUser" method="post">
           <table border="0" cellpadding="10" cellspacing="1" style="width:50%; border:1px solid #ccc; margin-top:40px; margin-left: auto; margin-right: auto" >
                    ...
                    <tr class="tableheader">
                        <td colspan="3">Assign File To Users</td>
                   ...
                   // boolean Authorised=false;
                    ...
                    <tr class="tablerow">
                     ...
                     <tr class="tablerow">
                    	 <td>Secret Key</td><td>:</td> <td><%= rs.getString("secKey") %>
                    	 <input type="hidden" name="fileSecKey" id="fileSecKey" value="<%= rs.getString("secKey") %>"></input>
                    	 </td>
                     </tr>
                      <tr class="tablerow">
                     ...
                     <tr class="tablerow">
                     	<td>Select Group</td><td>:</td>
                     	<td><%
                     	
                     	Statement st1= con.createStatement();
                     	GlobalFunction GF= new GlobalFunction();
                     	
                        ResultSet rs1 = st1.executeQuery("select * from usergroup where id <>1");
                        while(rs1.next()){
                        	String NumberOfUserUnGroup = GF.getNumberOfUserInGroup(rs1.getString("id"));
                        	%>
                        	<input type="radio" name="GroupId" value="<%= rs1.getInt("id") %>"><%= rs1.getString("GroupName")+"("+NumberOfUserUnGroup+")"%>
                      ...
                      <tr class="tablerow">
                     	<td>Access Level</td><td>:</td><td><input type="radio" name="AccessLevel" value="Write"> Write <input type="radio" name="AccessLevel" value="Read"> Read</td>
                     </tr>
                        <tr class="tablerow">
                        <%
           	...
           	%>
                     	<td>User key</td><td>:</td><td><input type="text" name="UserSecretKey" value="<%= RND %>"></input></td>
                     </tr>
