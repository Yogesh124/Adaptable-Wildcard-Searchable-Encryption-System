  ...
  <div id="container">
    ...
    <!--   <form action="search" method="post"> -->
      ...
      if(request.getParameter("done")!=null){
    	  try{
      HashSet<String> set = (HashSet)session.getAttribute("set");
      ...
      while(itr.hasNext())
      {
    	  String fid = itr.next().toString();
    	  String filename = GF.getFileName(Integer.parseInt(fid));
    	  
    	  %>
    	  <tr align="center">
    	  <td><%=i++ %></td>
    	  <td><%=filename %></td>
    	  <td><a href="DownloadServlet?fileName=<%= filename %>&fileId=<%=fid %>">Download</a></td>
    	  <%
      }
      %>
      </tr>
